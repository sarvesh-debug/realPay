...
<div class="card col-md-6 mx-auto shadow-lg border-0"> 
    <div class="controller mt-3 mx-5 loading">
    ...
    <div class="card-body p-4">
        <form action="{{ route('dmt.remitter.kyc') }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="mobile" name="mobileNumber" placeholder="Enter Mobile Number" maxlength="10" required />
            </div>
            ...
            <!-- Hidden Field for Reference Key -->
            <input type="hidden" name="referenceKey" id="referenceKey" value="{{$referenceKey}}">

          
                <textarea id="txtBiometricData" name="biometricData" rows="5" class="form-control" placeholder="Biometric Data will appear here"></textarea>
         

            <!-- Buttons -->
            <div class="d-flex justify-content-between mb-3">
                {{-- <button type="button" onclick="discoverAvdm();" class="btn btn-primary w-45">Discover AVDM</button> --}}
                <button type="submit" onclick="CaptureAvdm();" class="btn btn-danger w-45">Capture</button>
            </div>
...
function extractBiometricData(response) {
   ...
   mi: response?.PidData?.DeviceInfo?.["@attributes"]?.mi || "",
    ...
    Skey: response?.PidData?.Skey?.["#text"] || "",
