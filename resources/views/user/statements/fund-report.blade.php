...
@section('content')
<div class="container">
    <h1 class="mt-4">Fetch Ordered Transaction Statement</h1>
    <form action="{{ route('ordered-transactions.fetch') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary">Fetch Ordered Statement</button>
    </form>
</div>
@endsection
