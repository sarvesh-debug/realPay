          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                  ...
                  <li class="menu-item">
                    <a href="{{route('admin/user-lock')}}" class="menu-link">
                      <div data-i18n="Without navbar">Lock and Release</div>
                    </a>
                  </li>
                  {{-- <li class="menu-item">
                    <a href="{{route('merchant-list')}}" class="menu-link">
                      <div data-i18n="Without navbar">Merchant Onboard List</div>
                    </a>
                  </li> --}}
            ...
            {{-- <li class="menu-item">
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="{{route('aepsReport')}}" class="menu-link">
                      <div data-i18n="Without menu">AEPS Statement</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{route('dmt1Report')}}" class="menu-link">
                  ...
                  <li class="menu-item">
                    <a href="{{route('admin.trans.his')}}" class="menu-link">
                      <div data-i18n="Without navbar">Fund Transfer</div>
                    </a>
                  </li>
                  {{-- <li class="menu-item">
                    <a href="{{route('credit_card.history')}}" class="menu-link">
                      <div data-i18n="Without navbar">Credit Card Apply</div>
                    </a>
                  </li> --}}
                  {{-- <li class="menu-item">
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  ...
                  {{-- <li class="menu-item">
                    <a href="{{route('otherServices.form')}}" class="menu-link">
                      <div data-i18n="Without menu">Update Contact and Logo</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{route('otherServices.view')}}" class="menu-link">
                      <div data-i18n="Without menu">All Info</div>
                    </a>
                  </li> --}}
                  {{-- <li class="menu-item">
                    <a href="{{ route('bankdetails.edit', ['id' => '1']) }}" class="menu-link">
